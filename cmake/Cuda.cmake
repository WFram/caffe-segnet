...
set(Caffe_known_gpu_archs "30 35 50 86")
# 20 21(20)
################################################################################################
...
function(caffe_select_nvcc_arch_flags out_variable)
  # List of arch names
  set(__archs_names "Fermi" "Kepler" "Maxwell" "Ampere" "All" "Manual") # WF
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "Ampere") # WF
    set(__cuda_arch_bin "86") # WF
